...
class IncomeControllerTest {
    ...
    @Test
    void shouldReturnProperStatusAndContainsProperMediaTypeWithPostMethod() throws Exception {
        //given
        ...
        //when
        //then
        this.mockMvc.perform(MockMvcRequestBuilders.post(url, exampleInput)
    ...
    @Test
    void shouldReturnProperStatusAndContainsProperMediaTypeWithGetMethod() throws Exception {
        //given
